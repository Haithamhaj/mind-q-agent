...
import { Network, Share2, Database, Loader2, RefreshCw } from 'lucide-react';
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="bg-white p-6 rounded-xl border border-zinc-200 shadow-sm flex items-center">
                    ...
                    <div>
                        ...
                        <p className="text-2xl font-bold text-zinc-900">
                            {loading ? <Loader2 className="w-6 h-6 animate-spin" /> : (stats ? (stats.edges / Math.max(stats.nodes, 1)).toFixed(4) : '0')}
                        </p>
                    </div>
                </div>
            </div>
